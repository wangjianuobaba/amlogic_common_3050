...
/*debug information*/
#define SI2176_DEBUG                        1

#define i2c_client aml_demod_i2c
...
//   #define  SI2176_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_DEFAULT    0
   #define  SI2176_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_DEFAULT    1
...
#define si2176_init         __dtv_si2176_init
#define si2176_configure    __dtv_si2176_configure
#define si2176_tune         __dtv_si2176_tune
#define si2176_tuner_status __dtv_si2176_tuner_status
#define si2176_atv_status   __dtv_si2176_atv_status
#define si2176_atvconfig    __dtv_si2176_atvconfig
#define si2176_tunerconfig  __dtv_si2176_tunerconfig
#define si2176_loadvideofilter __dtv_si2176_loadvideofilter
#define si2176_tuner_tune_freq __dtv_si2176_tuner_tune_freq
#define si2176_powerupwithpatch __dtv_si2176_powerupwithpatch
#define firmwaretable           __dtv_firmwaretable
#define si2176_receiveproperty  __dtv_si2176_receiveproperty
#define si2176_sendproperty     __dtv_si2176_sendproperty
#define si2176_sendcommand  __dtv_si2176_sendcommand
#define si2176_loadfirmware __dtv_si2176_loadfirmware
#define si2176_startfirmware __dtv_si2176_startfirmware
#define si2176_commonconfig __dtv_si2176_commonconfig

int si2176_init(struct i2c_client *si2176, si2176_cmdreplyobj_t *rsp, si2176_common_reply_struct *common_reply);
//int (struct i2c_client *si2176, si2176_cmdreplyobj_t *rsp, si2176_common_reply_struct *common_reply);
...
int si2176_configure(struct i2c_client *si2176, si2176_propobj_t *prop, si2176_cmdreplyobj_t *rsp, si2176_common_reply_struct *common_reply, struct aml_tuner_sys *tuner_sys);
//int (struct i2c_client *si2176, unsigned char* vidfilttable, int lines, si2176_common_reply_struct *common_reply);
