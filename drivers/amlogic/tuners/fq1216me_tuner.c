...
#define TUNER_DEVICE_NAME               "fq1216me"
 ...
 */
#define PHILIPS_SET_PAL_I	    0xce//0x01
...
static int fq1216me_std_setup(u8 *cb, u32 *step_size)
{
    ...
    *cb = 0x86;
	...
	else if (fq1216me.std_id & TUNER_STD_PAL_I)
	{
        ...
        *step_size = TUNER_STEP_SIZE_3;  //TUNER_STEP_SIZE_0;      //base on the(bit[2:1] of cb) RAS & RSB, set the step size
	}
...
/* IFPCoff = Video Intermediate Frequency - Vif:
	...
	*/
    ...
    if (step_size > 0)
        ...
        div = (fq1216me.freq.freq + f_if)/TUNER_STEP_SIZE_0;  //with 50Khz step
