...
#define VDIN_START_CANVAS               24  //24~35 used to tvin  36-47 for nv21 or nv12 chroma canvas on m6
#define BT656IN_VF_POOL_SIZE            6//8
#define VIUIN_VF_POOL_SIZE              6//8
#define IT660XIN_VF_POOL_SIZE              4//8
...
#define IT660XIN_ANCI_DATA_SIZE        0x4000 

#if defined(CONFIG_ARCH_MESON6)
#define VDIN_START_CANVAS_CHROMA_OFFSET     (BT656IN_VF_POOL_SIZE+BT656IN_VF_POOL_SIZE)  //36-47 for nv21 or nv12 chroma canvas on m6
#endif
