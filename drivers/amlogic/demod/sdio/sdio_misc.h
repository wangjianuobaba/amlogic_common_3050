...
//clock low delay in transfer mode
#define sd_clk_delay_tranfer_low()        //   for(i_GPIO_timer=0;i_GPIO_timer<6;i_GPIO_timer++);
//clock high delay in transfer mode
#define sd_clk_delay_tranfer_high() 	//	for(i_GPIO_timer=0;i_GPIO_timer<6;i_GPIO_timer++);    
