...
#ifndef __AML_HW_SPI_H
#define __AML_HW_SPI_H

#define MESON_SPI_MASTER_A_START        CBUS_REG_ADDR(SPICC_RXDATA)
#define MESON_SPI_MASTER_A_END          (CBUS_REG_ADDR(SPICC_DWADDR+1)-1)
