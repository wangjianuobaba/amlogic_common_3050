...
#define WR2_CANVAS_BIT                   0   //Write chroma canvas address, for NV12/21 mode.
#define WR2_CANVAS_WID                   8
#endif

//#define VDIN_WR_CTRL                            0x1220
/* vdin do not need these registers*/
#if defined(CONFIG_ARCH_MESON6)
#define WR_HCONV_MODE_BIT            30   //vdin_wr_mif_hconv_mode. Applicable only to vdin_write_format=0 or 2
#define WR_HCONV_MODE_WID          2
//0=Output every even pixel's CbCr;
//1=Output every odd pixel's CbCr;
//2=Output an average value per even&odd pair of pixels;
//3=Output all CbCr. Only applys to vdin_write_format =2.
#endif
...
#if defined(CONFIG_ARCH_MESON6)
#define WR_SWAP_CBCR_BIT                 18   // vdin_wr_mif_swap_cbcr. Applicable only to vdin_write_format =2.0=Output CbCr (NV12);1=Output CrCb (NV21);
#define WR_SWAP_CBCR_WID                 1
#define WR_VCONV_MODE_BIT            16   //vdin_wr_mif_vconv_mode. Applicable only to vdin_write_format=2 , 0: even line 1: odd even 2: Reserved 3: all line
#define WR_VCONV_MODE_WID          2
#endif
#define WR_FMT_BIT                      12
#if defined(CONFIG_ARCH_MESON6)
#define WR_FMT_WID                      2    // 0: 422, 1: 444 directly send out 2: NV21 or NV12 for m6
#else
...
#define ASFIFO7_DE_EN_BIT               15
#define ASFIFO7_DE_EN_WID               1
#define ASFIFO7_GO_FLD_EN_BIT           14
#define ASFIFO7_GO_FLD_EN_WID           1
#define ASFIFO7_GO_LN_EN_BIT            13
#define ASFIFO7_GO_LN_EN_WID            1
#define ASFIFO7_NEG_ACTIVE_IN_VS_BIT    12
#define ASFIFO7_NEG_ACTIVE_IN_VS_WID    1
#define ASFIFO7_NEG_ACTIVE_IN_HS_BIT    11
#define ASFIFO7_NEG_ACTIVE_IN_HS_WID    1
#define ASFIFO7_VS_SOFT_RST_FIFO_EN_BIT 10
#define ASFIFO7_VS_SOFT_RST_FIFO_EN_WID 1
#define ASFIFO7_OVFL_STATUS_CLR_BIT     9
#define ASFIFO7_OVFL_STATUS_CLR_WID     1
#define ASFIFO7_SOFT_RST_BIT            8
#define ASFIFO7_SOFT_RST_WID            1    // write 1 & then 0 to reset
#define ASFIFO6_DE_EN_BIT               7
#define ASFIFO6_DE_EN_WID               1
#define ASFIFO6_GO_FLD_EN_BIT           6
#define ASFIFO6_GO_FLD_EN_WID           1
#define ASFIFO6_GO_LN_EN_BIT            5
#define ASFIFO6_GO_LN_EN_WID            1
#define ASFIFO6_NEG_ACTIVE_IN_VS_BIT    4
#define ASFIFO6_NEG_ACTIVE_IN_VS_WID    1
#define ASFIFO6_NEG_ACTIVE_IN_HS_BIT    3
#define ASFIFO6_NEG_ACTIVE_IN_HS_WID    1
#define ASFIFO6_VS_SOFT_RST_FIFO_EN_BIT 2
#define ASFIFO6_VS_SOFT_RST_FIFO_EN_WID 1
#define ASFIFO6_OVFL_STATUS_CLR_BIT     1
#define ASFIFO6_OVFL_STATUS_CLR_WID     1
#define ASFIFO6_SOFT_RST_BIT            0
#define ASFIFO6_SOFT_RST_WID            1    // write 1 & then 0 to reset
